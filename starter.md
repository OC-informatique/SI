...
Bienvenue ! Ce guide vous accompagne dans vos **premiers pas** avec le projet de galerie interactive. Pour des explications détaillées, consultez le [tutoriel complet](tutoriel-complet.md).
